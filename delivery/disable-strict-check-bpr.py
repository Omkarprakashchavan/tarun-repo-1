...
def main(module_name='', module_description='', repositories=[], default_managed_refspec=None):
    ...
    for repo in repositories:
        ...
        primary_workflows, optional_workflows, template_workflows, custom_branch_workflows = workflow_manifest(workflow_manifest_file)
...
def workflow_manifest(manifest_file):
    ...
    return data.get('primary_workflows', []), data.get('optional_workflows', []), data.get('template_workflows', []), data.get('custom_branch_workflows', [])
